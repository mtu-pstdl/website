...
const news: News[] = [
	...
	},
	{
		...
		content: "The T-REX presented at the BIG IDEA 2020 conference. Following their presentation, the T-REX team had a Q&A with NASA scientists and the public.",
...
function getDateStamp(news: News): number {
	return (news.date.year * 1000) + ((news.date.month ?? 100) * 10) + (news.date.day ?? 0);
}
